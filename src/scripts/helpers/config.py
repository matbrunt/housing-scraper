...
def read_config():
    config_path = os.path.abspath(os.path.join(__file__, os.pardir, os.pardir, os.pardir, 'config.yaml'))
...
def read_credentials(section=None):
    credentials_path = os.path.abspath(os.path.join(__file__, os.pardir, os.pardir, os.pardir, 'credentials.txt'))
